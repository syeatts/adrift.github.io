...
const AppDungeons = class {
    ...
    render() {
        return (h("div", { class: 'app-dungeons' }, h("p", null, "Welcome to Dungeons. (Coming Soon)")));
    }
};
AppDungeons.style = appDungeonsCss;
